...
#
# Host: 172.105.69.174 (MySQL 5.7.29-0ubuntu0.18.04.1)
# Database: chatneomerp
# Generation Time: 2020-04-24 19:20:24 +0000
# ************************************************************
...
# Dump of table gr_alerts
# ------------------------------------------------------------

DROP TABLE IF EXISTS `gr_alerts`;
...
# Dump of table gr_customize
# ------------------------------------------------------------

DROP TABLE IF EXISTS `gr_customize`;
...
LOCK TABLES `gr_customize` WRITE;
/*!40000 ALTER TABLE `gr_customize` DISABLE KEYS */;

INSERT INTO `gr_customize` (`id`, `name`, `element`, `device`, `type`, `v1`, `v2`, `xtra`)
VALUES
...
/*!40000 ALTER TABLE `gr_customize` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table gr_defaults
# ------------------------------------------------------------

DROP TABLE IF EXISTS `gr_defaults`;
...
LOCK TABLES `gr_defaults` WRITE;
/*!40000 ALTER TABLE `gr_defaults` DISABLE KEYS */;

INSERT INTO `gr_defaults` (`id`, `type`, `v1`, `v2`, `v3`, `v4`, `v5`, `v6`, `v7`, `tms`)
VALUES
	(1,'default','sitename','Chat Neom ERP','0','0','0','','',NULL),
	(2,'default','sitedesc','NEOM ERP Chat','0','0','0','','',NULL),
	(3,'default','siteslogan','NEOM ERP Chat','0','0','0','','',NULL),
	(4,'default','sysemail','riaan@number7even.com','0','0','0','','',NULL),
	(5,'default','sendername','Chat Neom ERP','0','0','0','','',NULL),
	(6,'default','userreg','enable','0','0','0','','',NULL),
	(7,'default','timezone','Europe/Berlin','0','0','0','','','2019-04-06 18:10:19'),
...
/*!40000 ALTER TABLE `gr_defaults` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table gr_logs
# ------------------------------------------------------------

DROP TABLE IF EXISTS `gr_logs`;
...
LOCK TABLES `gr_logs` WRITE;
/*!40000 ALTER TABLE `gr_logs` DISABLE KEYS */;

INSERT INTO `gr_logs` (`id`, `type`, `v1`, `v2`, `v3`, `xtra`, `tms`)
VALUES
	(1,'cache',1587275289,0,NULL,'reset','2020-04-19 07:48:09'),
	(2,'browsing',1,NULL,'7','group','2020-04-13 17:27:26');

/*!40000 ALTER TABLE `gr_logs` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table gr_mails
# ------------------------------------------------------------

DROP TABLE IF EXISTS `gr_mails`;
...
LOCK TABLES `gr_mails` WRITE;
/*!40000 ALTER TABLE `gr_mails` DISABLE KEYS */;

INSERT INTO `gr_mails` (`id`, `uid`, `type`, `valz`, `code`, `sent`, `tms`)
VALUES
	(1,'4','signup','0','k9ExG',1,'2020-04-13 20:58:57');

/*!40000 ALTER TABLE `gr_mails` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table gr_msgs
# ------------------------------------------------------------

DROP TABLE IF EXISTS `gr_msgs`;
...
LOCK TABLES `gr_msgs` WRITE;
/*!40000 ALTER TABLE `gr_msgs` DISABLE KEYS */;

INSERT INTO `gr_msgs` (`id`, `gid`, `uid`, `msg`, `type`, `rtxt`, `rid`, `rmid`, `rtype`, `cat`, `xtra`, `tms`)
VALUES
	(1,'7',1,'created_group','system','0',0,0,'msg','group','0','2020-04-13 20:57:25'),
	(2,'7',1,'1LzPegMza.png','file','0',0,0,'msg','group','basic_elaboration_browser_download.png','2020-04-13 20:57:58');

/*!40000 ALTER TABLE `gr_msgs` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table gr_options
# ------------------------------------------------------------

DROP TABLE IF EXISTS `gr_options`;
...
LOCK TABLES `gr_options` WRITE;
/*!40000 ALTER TABLE `gr_options` DISABLE KEYS */;

INSERT INTO `gr_options` (`id`, `type`, `v1`, `v2`, `v3`, `v4`, `v5`, `v6`, `v7`, `tms`)
VALUES
	(1,'profile','name','NEOM','1','admin','#FF0055','','','0000-00-00 00:00:00'),
	(2,'profile','name','BaeVox','2','baevox','#1EB557','0','0','2020-03-03 16:28:40'),
	(5,'profile','status','online','1','0','0','0','0','2020-04-19 11:19:57'),
	(6,'profile','autotmz','Europe/Helsinki','1','0','0','0','0','2020-04-19 11:19:57'),
	(7,'group','NEOM Support','0','0','pBvQcV','0','0','0','2020-04-13 20:57:25'),
	(8,'gruser','7','1','2','0','0','0','0','2020-04-13 20:57:25'),
	(9,'lview','7','1','2','0','0','0','0','2020-04-13 20:57:25'),
	(10,'profile','name','Support Agent','4','support','#451927','0','0','2020-04-13 20:58:57'),
	(11,'profile','tmz','Europe/Berlin','1','0','0','0','0','2020-04-19 11:18:09'),
	(12,'profile','alert','gem/ore/grupo/alerts/alert003.mp3','1','0','0','0','0','2020-04-19 11:18:09'),
	(13,'profile','language','','1','0','0','0','0','2020-04-19 11:19:56');

/*!40000 ALTER TABLE `gr_options` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table gr_permissions
# ------------------------------------------------------------

DROP TABLE IF EXISTS `gr_permissions`;
...
LOCK TABLES `gr_permissions` WRITE;
/*!40000 ALTER TABLE `gr_permissions` DISABLE KEYS */;

INSERT INTO `gr_permissions` (`id`, `name`, `groups`, `features`, `files`, `users`, `languages`, `sys`, `roles`, `fields`, `privatemsg`, `autodel`, `autounjoin`)
VALUES
...
/*!40000 ALTER TABLE `gr_permissions` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table gr_phrases
# ------------------------------------------------------------

DROP TABLE IF EXISTS `gr_phrases`;
...
LOCK TABLES `gr_phrases` WRITE;
/*!40000 ALTER TABLE `gr_phrases` DISABLE KEYS */;

INSERT INTO `gr_phrases` (`id`, `type`, `short`, `full`, `lid`)
VALUES
...
/*!40000 ALTER TABLE `gr_phrases` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table gr_profiles
# ------------------------------------------------------------

DROP TABLE IF EXISTS `gr_profiles`;
...
LOCK TABLES `gr_profiles` WRITE;
/*!40000 ALTER TABLE `gr_profiles` DISABLE KEYS */;

INSERT INTO `gr_profiles` (`id`, `type`, `uid`, `name`, `cat`, `v1`, `v2`, `req`, `tms`)
VALUES
	...
	(20,'profile',1,'5',NULL,'Male',NULL,0,NULL);

/*!40000 ALTER TABLE `gr_profiles` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table gr_session
# ------------------------------------------------------------
...
LOCK TABLES `gr_session` WRITE;
/*!40000 ALTER TABLE `gr_session` DISABLE KEYS */;

INSERT INTO `gr_session` (`id`, `uid`, `device`, `code`, `tms`, `try`)
VALUES
	(120,1,'93.254.55.107mozilla5.0macintoshintelmacosx10116applewebkit537.36khtmllikegeckochrome80.0.3987.163safari537.36','pZjRgwmE4NRzEL','2020-04-13 17:50:06','0'),
	(122,1,'93.255.159.96mozilla5.0macintoshintelmacosx10116applewebkit537.36khtmllikegeckochrome80.0.3987.163safari537.36','0vAobyijn222LH','2020-04-19 10:09:31','0');

/*!40000 ALTER TABLE `gr_session` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table gr_users
# ------------------------------------------------------------
...
LOCK TABLES `gr_users` WRITE;
/*!40000 ALTER TABLE `gr_users` DISABLE KEYS */;

INSERT INTO `gr_users` (`id`, `name`, `email`, `pass`, `mask`, `depict`, `role`, `created`, `altered`, `extra`)
VALUES
	(1,'admin','riaan@number7even.com','c9079279438818788245ec077b416736','S1L8SY8VxEx73R',4,2,'2019-04-11 16:54:11','2020-04-19 11:18:09','0'),
	(2,'baevox','hello@baevox.com','5e3c2f7dab96392ff7bb0beb75a6ee90','plUHzz8mpj8yT',4,2,'2020-03-03 16:28:40','2020-03-03 16:28:40','0'),
	(4,'support','support@neom-erp.com','f75280a6bb6061d6a54f7475f7e8dd44','I06GiAxc9ZKYz',8,2,'2020-04-13 20:58:57','2020-04-13 20:58:57','0');

/*!40000 ALTER TABLE `gr_users` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table gr_utrack
# ------------------------------------------------------------

DROP TABLE IF EXISTS `gr_utrack`;
...
LOCK TABLES `gr_utrack` WRITE;
/*!40000 ALTER TABLE `gr_utrack` DISABLE KEYS */;

INSERT INTO `gr_utrack` (`id`, `ip`, `dev`, `uid`, `status`, `tms`)
VALUES
	(45,'93.254.55.107','mozilla5.0macintoshintelmacosx10116applewebkit537.36khtmllikegeckochrome80.0.3987.163safari537.36',1,0,'2020-04-13 20:52:47'),
	(46,'93.255.159.96','mozilla5.0macintoshintelmacosx10116applewebkit537.36khtmllikegeckochrome80.0.3987.163safari537.36',1,0,'2020-04-19 11:19:56');

/*!40000 ALTER TABLE `gr_utrack` ENABLE KEYS */;
UNLOCK TABLES;
